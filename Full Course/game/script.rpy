...
define NIKOLAS = Character("Nick")
define NICKOLAUS = Character("Nick")
define NIKOLAUS = Character("Nick")
define ARIA = Character("Aria")
define Lasagna = Character("Aria")
...
label start:
    ...
    MC "That we don’t have one, this is a family style restaurant."
    ...
    NICKOLAUS "WHY IS THIS ROOM SO COLD?!?"

    MC  "-it’s to the refrigerator. But it is a door and it is in the back."

    NIKOLAUS "What is meaning of this!"

    MORGAN "Kinda. I mean, the other guy is handling smoked fish back there. I’ve done worse."

    NIKOLAUS "He said you were the chef!"
    ...
    NIKOLAUS "Why is there no authentic German cuisine on your menu!"

    MORGAN "Because this is primarily an american family style restaurant."
    
    NIKOLAUS "Then why not have authentic German-"

    MORGAN "Because this is a good family style restaurant."

    NIKOLAUS "You didn’t even let me finish!"

    MORGAN "Because it was going to be awful."

    NIKOLAUS "HOW DARE YOU INSULT MY PROUD AND MAGNIFICENT CULTURE!?! YOU BACKWARDS AMERICANS THINK YOU KNOW EVERYTHING DON’T YOU!?!"
    ...
    NIKOLAUS "Meatballs are not flavourless and not paste, they are a moist and bouncy! Also you can buy it can-"
    ...
    NIKOLAUS "All the more reason to have it!"
    ...
    NIKOLAUS "Sir, this “chef” is insulting the proud traditional cooking of my great people, and I will not stand for it!"
    ...
    NIKOLAUS "Wait where are you going chef? I haven’t properly thanked you!"
    ...
    NIKOLAUS "Oh! Well i’m very sorry sometimes I don’t realize my own strength but I am very grateful that you went out of your way to make specialty meal for me!" 
    ...
    NIKOLAUS "Well, yes. Yes I do. I’ve been looking for a roommate, but everyone keeps turning me down. It’s for an apartment designated for international students, so it’s actually rather inexpensive."

    MORGAN "That was rhetorical. I mean, I appreciate it, but I don’t think it will be enough."

    NIKOLAUS "Also you can work somewhere else? You sure seem to be a very good cook. The first two plates I had were delicious, though I would have preferred some more proud traditional-"
    ...
    NIKOLAUS "Food was very good. A bit light for my tastes, but very good!"
    ...
    NIKOLAUS "What kind of mother would do such a thing?"
    ...
    MC "You know, that sounds like a plan. What’s your name?"
    ...
    Lasagna "-CAUSE YOU AX FUR IT CaUSE you need SOME!-"
    ...
    NIKOLAUS "Do not insult your sister. She is a good beautiful girl."
    ...
    NIKOLAUS "I have no violent intentions!"
    ...
    NIKOLAUS "Yes, I am very calm. Always calm."
    ...
    NIKOLAUS "We will do no bothering sing lady."

    MORGAN "Sing lady?"

    NIKOLAUS "You do not recognize sing lady?"

    MORGAN "Recognize what?"

    NIKOLAUS "She is at your place of work all the time. She is sing lady. You must at least remember her voice."
    ...
    NIKOLAUS "I miss you sometimes sing lady."
    ...
    NIKOLAUS "I have told you many times he is not a proud Ger-"
